...
void MPU_setup() {
  ...
  i2cData[2] = 0x00; // Set Gyro Full Scale Range to Ãƒâ€šÃ‚Â±250deg/s
  i2cData[3] = 0x00; // Set Accelerometer Full Scale Range to Ãƒâ€šÃ‚Â±2g
  ...
  // atan2 outputs the value of -Ãƒï¿½Ã¢â€šÂ¬ to Ãƒï¿½Ã¢â€šÂ¬ (radians) - see http://en.wikipedia.org/wiki/Atan2
